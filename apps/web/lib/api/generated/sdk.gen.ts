 ...
 */
export const createGuestSession = <ThrowOnError extends boolean = false>(options?: Options<CreateGuestSessionData, ThrowOnError>) => (options?.client ?? client).post<CreateGuestSessionResponses, CreateGuestSessionErrors, ThrowOnError>({ url: '/api/guest-sessions', ...options });
 ...
 */
export const refreshGuestSession = <ThrowOnError extends boolean = false>(options?: Options<RefreshGuestSessionData, ThrowOnError>) => (options?.client ?? client).post<RefreshGuestSessionResponses, RefreshGuestSessionErrors, ThrowOnError>({
 ...
 */
export const deleteRun = <ThrowOnError extends boolean = false>(options: Options<DeleteRunData, ThrowOnError>) => (options.client ?? client).delete<DeleteRunResponses, DeleteRunErrors, ThrowOnError>({ url: '/api/runs/{run_id}', ...options });
 ...
 */
export const submitApproval = <ThrowOnError extends boolean = false>(options: Options<SubmitApprovalData, ThrowOnError>) => (options.client ?? client).post<SubmitApprovalResponses, SubmitApprovalErrors, ThrowOnError>({
 ...
 */
export const answerClarification = <ThrowOnError extends boolean = false>(options: Options<AnswerClarificationData, ThrowOnError>) => (options.client ?? client).post<AnswerClarificationResponses, AnswerClarificationErrors, ThrowOnError>({
 ...
 */
export const exportRun = <ThrowOnError extends boolean = false>(options: Options<ExportRunData, ThrowOnError>) => (options.client ?? client).post<ExportRunResponses, ExportRunErrors, ThrowOnError>({
 ...
 */
export const getLivenessHealthLiveGet = <ThrowOnError extends boolean = false>(options?: Options<GetLivenessHealthLiveGetData, ThrowOnError>) => (options?.client ?? client).get<GetLivenessHealthLiveGetResponses, unknown, ThrowOnError>({ url: '/health/live', ...options });
